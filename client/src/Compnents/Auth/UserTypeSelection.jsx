    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        {userTypes.map((userType, index) => (
          ...
          >
            <button
              className={`w-full h-64 bg-gray-800 rounded-2xl p-6 flex flex-col items-center justify-center text-center transition-transform transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-${
            ...
            >
              <div
                className={`mb-4 p-3 rounded-full bg-gradient-to-br ${userType.gradient}`}
              >
